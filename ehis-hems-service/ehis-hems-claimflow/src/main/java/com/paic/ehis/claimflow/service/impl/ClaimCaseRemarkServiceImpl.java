...
import com.paic.ehis.claimflow.mapper.ClaimCaseRemarkMapper;
...
public class ClaimCaseRemarkServiceImpl implements IClaimCaseRemarkService
{
    ...
    {
        claimCaseRemark.setRemarkType("01");
    ...
    public List<ClaimCaseRemark> selectClaimCaseRemarkByRptNo(String rptNo){
        return claimCaseRemarkMapper.selectClaimCaseRemarkByRptNo(rptNo);
    }
}
