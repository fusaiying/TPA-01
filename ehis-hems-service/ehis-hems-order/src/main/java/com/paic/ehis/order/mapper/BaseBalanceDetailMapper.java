...
/**
 * base_balance_detail(服务结算明细信息)Mapper接口
 * 
 * @author sino
 * @date 2021-01-21
 */
public interface BaseBalanceDetailMapper 
{
    /**
    ...
    /**
     * 删除base_balance_detail(服务结算明细信息)
     *
     * @param serialNo base_balance_detail(服务结算明细信息)ID
     * @return 结果
     */
    ...
    /**
     * base_balance_detail(服务结算明细信息)
     * @param baseBalanceDetail base_balance_detail(服务结算明细信息)
     * @return 结果
     */
    public int updateBaseBalanceDetailByTaskNo(BaseBalanceDetail baseBalanceDetail);
