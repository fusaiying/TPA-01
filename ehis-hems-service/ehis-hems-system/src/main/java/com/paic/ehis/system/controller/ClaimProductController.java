...
import com.paic.ehis.system.domain.dto.*;
...
public class ClaimProductController extends BaseController
{
    ...
    public TableDataInfo publicList(ClaimProduct claimProduct)
    {
        TableSupport.setSort("desc");
        TableSupport.setOrderByColumn("update_time");
        startSortPage();
     ...
     */
    @PreAuthorize("@ss.hasPermi('system:product:list')")
    @GetMapping("/selectClaimProductList")
    public TableDataInfo selectClaimProductList(ClaimProductDTO claimProductDTO)
    {
        startPage();
    ...
    {
        claimProductService.updateClaimProduct(updateClaimProductDTO);
    ...
    public AjaxResult selectSysUser(SysUserDTO sysUserDTO)
    {
        startPage();
    ...
    public TableDataInfo untreatedList(ClaimProduct claimProduct)
    {
        TableSupport.setSort("desc");
        TableSupport.setOrderByColumn("update_time");
        startSortPage();
    ...
    public TableDataInfo processedList(ProcessedProductDTO processedProductDTO)
    {
        TableSupport.setSort("desc");
        TableSupport.setOrderByColumn("update_time");
        startSortPage();
    ...
    @PostMapping("/export")
    public void export(HttpServletResponse response, ClaimProduct claimProduct) throws IOException
    {
        List<ClaimProduct> list = claimProductService.selectClaimProductList(claimProduct);
    ...
    @PreAuthorize("@ss.hasPermi('system:product:list')")
    @GetMapping("/listAndPublicPool")
    public TableDataInfo listAndPublicPool(ClaimProduct claimProduct)
    {
        startPage();
    ...
    @PreAuthorize("@ss.hasPermi('system:product:list')")
    @GetMapping("/listAndPersonalPoolFinish")
    public TableDataInfo listAndPersonalPoolFinish(ClaimProduct claimProduct)
    {
        startPage();
    ...
    @PreAuthorize("@ss.hasPermi('system:product:list')")
    @GetMapping("/listAndPersonalPoolUnfinished")
    public TableDataInfo listAndPersonalPoolUnfinished(ClaimProduct claimProduct)
    {
        startPage();
    ...
    //产品查询   工作池
    @PreAuthorize("@ss.hasPermi('system:product:list')")
    @GetMapping("/selectProductQuery")
    public TableDataInfo selectProductQuery(ClaimProductDTO claimProductDTO){
        startPage();
