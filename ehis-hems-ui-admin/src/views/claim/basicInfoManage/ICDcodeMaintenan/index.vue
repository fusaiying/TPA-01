...
<script>
  import {getICDList, deleteICDCode} from '@/api/baseInfo/ICDcodeMaintenan.js'

  export default {

    data() {
      const checkIcdcode = (rules, value, callback) => {
        if (!value) {
      ...
      return {
        ...
        loading: true,
        rules: {
          icdcode: [{validator: checkIcdcode, trigger: 'blur'}],
    ...
    methods: {
      ...
      delConfirm() {
        ...
        deleteICDCode(this.icdcode).then(res => {
