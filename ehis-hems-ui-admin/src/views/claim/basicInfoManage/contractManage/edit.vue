          ...
          <el-col :span="8">
            <el-form-item label="合约类型"  prop="contractType" key="contractType1">
              <el-select v-model="searchForm.contractType" class="item-width" size="mini" placeholder="请选择">
                <el-option v-for="option in supplierContractTypes" :key="option.dictValue" :label="option.dictLabel" :value="option.dictValue" />
              </el-select>
            </el-form-item>
          </el-col>
      ...
      <el-form ref="providerForm" :model="providerForm" v-if="!formTab"  style="padding-bottom: 30px;margin-top:20px" label-width="150px" :rules="providerRules"
        ...
        <el-row>
          ...
          <el-col :span="8" v-if="countItem">
            <el-form-item label="次均控费：" prop="averageCost">
              <el-input  maxlength="14" @input="changePrice('averageCost')" :disabled="isShow" v-model="providerForm.averageCost" class="item-width" clearable size="mini"
                        placeholder="请录入"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="16" v-if="distcoteItem">
            <el-form-item label="检查费折扣：" prop="examineDiscount">
              <el-input maxlength="4" @input="changePrice('examineDiscount')" :disabled="isShow" v-model="providerForm.examineDiscount"  class="item-width" clearable size="mini"
                        placeholder="请录入"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="8" v-if="countItem">
            <el-form-item label="次均控费类型：" prop="type">
              <el-select v-model="providerForm.type" class="item-width" size="mini" placeholder="请选择">
                <el-option v-for="option in onceTypes" :key="option.dictValue" :label="option.dictLabel" :value="option.dictValue" />
              </el-select>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="8" v-if="countItem">
            <el-form-item label="就诊次数：" prop="advicenum">
              <el-input  maxlength="14" @input="changePrice('advicenum')"  :disabled="isShow" v-model="providerForm.advicenum"  class="item-width" clearable size="mini"
                        placeholder="请录入"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="16" v-if="distcoteItem">
            <el-form-item label="护理费折扣：" prop="allowance">
              <el-input  maxlength="4" @input="changePrice('allowance')"  :disabled="isShow" v-model="providerForm.allowance"  class="item-width" clearable size="mini"
                         placeholder="请录入"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="16" v-if="distcoteItem">
            <el-form-item label="医药费折扣：" prop="costs">
              <el-input  maxlength="4" @input="changePrice('costs')"  :disabled="isShow" v-model="providerForm.costs"   class="item-width" clearable size="mini"
                         placeholder="请录入"/>
            </el-form-item>
          </el-col>
          ...
          <el-col :span="16">
            <el-form-item label="直结类型：" prop="straightT">
              <el-checkbox-group v-model="providerForm.straightT">
                <el-checkbox v-for="item in directContractTypes" :label="item.dictValue" :key="item.dictValue">{{item.dictLabel}}</el-checkbox>
              </el-checkbox-group>
        ...
        <el-col :span="8">
          <el-form-item label="办公电话：" prop="tel">
            <el-input maxlength="100"  oninput = "value=value.replace(/[^\d]/g,'')" :disabled="isShow" v-model="providerForm.tel" class="item-width" clearable size="mini"
                      placeholder="请录入"/>
          </el-form-item>
        </el-col>
...
-->
        ...
        <el-table-column prop="settleType" label="结算方式" align="center">
          <template slot-scope="scope">
            <el-form-item style="display: inline-flex !important;"  v-if="scope.row.editing" :rules="serverInfoRules.settleType" :prop="'serverInfo.' + scope.$index + '.settleType'">
        ...
        <el-table-column prop="settleCurrency" label="结算币种"  align="center"> <!-- currencys --> <!-- getCurrencyName -->
          <template slot-scope="scope">
            <el-form-item style="display: inline-flex !important;" v-if="scope.row.editing" :rules="serverInfoRules.settleCurrency" :prop="'serverInfo.' + scope.$index + '.settleCurrency'">
