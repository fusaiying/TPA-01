    ...
    <el-card class="box-card" style="margin-top: 10px;">
      <el-form ref="form" :model="form" style="padding-bottom: 30px;padding-top: 30px" label-width="130px" label-position="right" size="mini">
        ...
        <el-row>
          ...
          <el-col :span="8" v-if="supplierTypeSect">
            <el-form-item label="合约类型：" prop="supContractType">
              <el-select v-model="form.supContractType" class="item-width" size="mini" placeholder="请选择">
                <el-option v-for="option in supplierContractTypes" :key="option.dictValue" :label="option.dictLabel" :value="option.dictValue" />
              </el-select>
            </el-form-item>
          </el-col>

          <el-col :span="8" v-if="proTypeSect">
        ...
        <div style="text-align: right; margin-right: 10px;">
          <el-row>
            <el-form-item class="but1">
              <el-button size="mini" type="success" icon="el-icon-search" @click="getTableData">查 询</el-button>
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="" label="类别" align="center" :formatter="getFlagName" show-overflow-tooltip />
          <el-table-column prop="servcomNo" label="供应商/服务机构名称" :formatter="getServcomNoName" align="center" show-overflow-tooltip />
...
<script>
  ...
  export default {
    ...
    methods: {
      flagChange(value){
        if(value == '01') {
          this.supplierTypeSect = true;
          this.proTypeSect = false;
        }  else {
          this.proTypeSect = true;
