    ...
    <el-card class="box-card">
      ...
      <div>
        ...
        <el-table
          ...
          tooltip-effect="dark"
          style="width: 100%;">
          <el-table-column label="规则编码" prop="ruleno" align="center" show-overflow-tooltip/>
          <el-table-column label="出单公司" prop="companyname" align="center" show-overflow-tooltip/>
          <el-table-column label="产品名称" prop="riskName" align="center" show-overflow-tooltip/>
          <el-table-column label="结算类型" prop="accounttype" align="center" :formatter="getAccounttypeOptions" show-overflow-tooltip>
          </el-table-column>
          <el-table-column label="服务费/人" prop="servicefee" align="center" show-overflow-tooltip/>
          <el-table-column label="保费比例%" prop="premrate" align="center" show-overflow-tooltip/>
        </el-table>
        <!--分页组件-->
        <pagination
          v-show="totalCount>0"
