...
<el-upload
  ...
  :limit="3"
  :file-list="fileList">
          <el-button size="mini" type="success" @click="saveHandle">添加附件</el-button>
</el-upload>
        </span>
      </div>
      <el-table ref="annexInfoForm" :data="annexInfoForm" :header-cell-style="{color:'black',background:'#f8f8ff'}"
        ...
        <el-table-column align="center" label="操作" min-width="94" fixed="right">
          <template slot-scope="scope">
            <el-button  size="small" type="text" @click="delHandle(scope.$index, scope.row)">
              删除
            </el-button>
