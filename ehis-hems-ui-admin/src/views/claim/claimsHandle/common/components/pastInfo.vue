                  ...
                  <el-form label-width="120px" label-position="right" >
                    <el-col :span="8">
                      <el-form-item label="理赔类型 ：">
                        <span>{{ getCasetype(props.row) }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="申请类别 ：">
                        <span>{{ getApplicationType(props.row,'') }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                    ...
                    <el-col :span="8">
                      <el-form-item label="身份证号 ：">
                        <span>{{ props.row.applicantidcardno }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="申请人手机号 ：">
                        <span>{{ props.row.applicantmobile }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="与出险人关系 ：">
                        <span>{{ getRelationtoinsured(props.row,'') }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="出险类型 ：">
                        <span>{{ getIncidenttype(props.row,'') }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                      <el-form-item label="出险日期 ：">
                        <span>{{ props.row.eventdate }}</span>
                      </el-form-item>
                    </el-col>
                    <el-col :span="8">
                    ...
                    <el-col :span="8">
                      <el-form-item label="主要诊断 ：">
                        <span>{{ props.row.maindiagnosis }}</span>
                      </el-form-item>
                    </el-col>
                  </el-form>
                </template>
...
import {isMySystem4ClaimNo} from '@/api/search/index'
export default {
  ...
  methods: {
    getConclusion(row,col) {
      ...
      return this.selectDictLabel(this.conclusionOptions, str)
    },
    getQueueClaimStatus(row,col) {
      /*return this.dict.label.queue_claim_status[row.status]*/
      return this.selectDictLabel(this.queue_claim_statusOptions, row.status)
    },
    delarNum(row) {
