<template>
  <el-table
    ...
    tooltip-effect="dark"
    style="width: 100%;">
   <el-table-column sortable align="center" prop="claimno" min-width="160" label="赔案号" show-overflow-tooltip></el-table-column>
   ...
   <el-table-column sortable align="center" min-width="100" prop="idcardno" label="证件号码" show-overflow-tooltip/>
...
<!--   <el-table-column sortable align="center" min-width="100" prop="acceptdate" label="受理日期" show-overflow-tooltip></el-table-column>-->
   <el-table-column sortable align="center" min-width="100" :formatter="formatLimitation" prop="limitation" label="时效" show-overflow-tooltip></el-table-column>
   ...
   <el-table-column v-if="status==='03'" sortable align="center" min-width="100" prop="conclusion" label="当前结论">
    <template slot-scope="scope">
      <span>复核-{{scope.row.conclusion}}</span>
    </template>
   </el-table-column>
   ...
   <el-table-column sortable v-if="status==='02'" align="center" min-width="100" :formatter="formatClaimStatus" prop="status" label="赔案状态" show-overflow-tooltip></el-table-column>
    ...
    <el-table-column align="center"  min-width="94" label="操作" fixed="right">
      <template slot-scope="scope">
        ...
        <el-button size="small" v-if="status==='02'" :disabled="(scope.row.status != '13' && scope.row.status != '15') || scope.row.lastnode !='12'" type="text" @click="recovery(scope.row)">回收</el-button>
      </template>
    </el-table-column>
  </el-table>
</template>
