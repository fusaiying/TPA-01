          ...
          <el-col :span="8">
            <el-form-item label="申请来源：" prop="applicationsource">
              <el-select class="item-width" v-model="searchForm.applicationsource" placeholder="请选择">
                <el-option v-for="item in sourcetypeOptions" :key="item.dictValue" :label="item.dictLabel" :value="item.dictValue"></el-option>
              </el-select>
            </el-form-item>
          </el-col>
          <el-col :span="8">
      ...
      <div style="position: relative; margin-top: 30px;">
        ...
        <el-tabs v-model="activeName" v-loading="loading">
          ...
          <el-tab-pane :label="`已处理(${finishTotal})`" name="02">
            <claimsTable :tableData="completedTableData" :status="activeName" @init-data="allSearch"></claimsTable>
          </el-tab-pane>
...
export default {
  ...
  methods: {
    ...
    getOneCase(){
      ...
      const node = 'claim_preliminary_examination'
