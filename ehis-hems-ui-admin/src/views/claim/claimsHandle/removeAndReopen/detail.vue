      ...
      <el-col :span="18">
        <div style="margin-left: 6px;">
          ...
          <el-card style="margin-top: 10px;">
            ...
            <el-row>
              <el-form ref="resultForm" disabled :model="resultForm" size="mini" label-width="94px">
                <el-col :span="7">
...
import insureModal from "../common/modul/insuredInfo"
import applicantModal from '../common/modul/applicant';
import payeeModal from "../common/modul/payee";
import imagesModal from "../common/modul/images"
// import materialsModal from "../common/modul/materials"
export default {
  components: {
    policyTable,
    claimsTable,
