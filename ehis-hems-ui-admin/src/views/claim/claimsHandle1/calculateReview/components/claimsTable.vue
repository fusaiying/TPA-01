<template>
  <el-table
    ...
    <el-table-column key="8" v-if="activeName==='01'" align="center" prop="claimType" label="监控时效" min-width="120" show-overflow-tooltip/>
    <el-table-column key="9" align="center" prop="claimType" label="是否调查" min-width="120" show-overflow-tooltip/>
    <el-table-column key="10" align="center" prop="updateBy" label="提交用户" min-width="120" show-overflow-tooltip/>
    <el-table-column key="11" align="center" fixed="right" label="操作" min-width="94" show-overflow-tooltip>
      <template slot-scope="scope">
        ...
        <el-button v-if="activeName==='02' || activeName==='03' " size="small" type="text"
