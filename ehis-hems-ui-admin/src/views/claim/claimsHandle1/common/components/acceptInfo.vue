  ...
  export default {
    ...
    watch: {
      baseInfo:function (newValue) {
        this.baseInfoDatabaseInfoData = newValue
      },
    },
    components: {},
    filters: {},
    data() {
      ...
      return {
        ...
        baseForm: {
          ...
          preAuthNo: undefined,
          materialCompleteDate: undefined,
          receiptDate: undefined,
          priReason: undefined,
          accProvince: undefined,
          accCity: undefined,
          accDistric: undefined,
    ...
    async mounted() {
      ...
      let date = new Date()
      this.baseForm.materialCompleteDate = date.getFullYear() + "-" + (date.getMonth() + 1) + "-" + date.getDate()
      this.getAddressData()
    ...
    methods: {
      ...
      handleChange(value) {
        ...
        this.baseForm.accDistric = value[2]
      },
      checkedAllFun() {
      ...
      save() {
        ...
        let data = {
          ...
          accProvince: this.baseForm.accProvince,
          accCity: this.baseForm.accCity,
          accDistric: this.baseForm.accDistric,
