<template>
  <el-card class="box-card" style="margin-top: 10px;" id="insureed">
    <div slot="header" class="clearfix">
      <div style="width: 100%;cursor: pointer;">
        ...
        <span style="float: right;">
         <el-button type="primary" :disabled="!collapsed" size="mini" @click="policySearch">查询</el-button>
         <el-button type="primary" :disabled="!collapsed" size="mini" @click="saveHandle">保存</el-button>
      </span>
      </div>

    </div>
    <el-form v-show="collapsed" ref="baseForm" :rules="tableFormRules" :disabled="node === 'accept' && status === 'show'"
             :model="baseForm"
      ...
      <el-row>
        <el-table
          ...
          <el-table-column align="center" prop="policyType" label="保单类型" show-overflow-tooltip/>
          <el-table-column align="center" prop="ssFlag" label="社保标记" show-overflow-tooltip/>
    ...
    <!-- 保单信息查询模态框 -->
    <insured-modal :value="dialogPolicy" :dictList="dictList" :node="node" @infoShow="insuredInfoShow"  @getPropData="getPropData"
...
<script>
  ...
  let dictss = [{dictType: 'rgtSex'}, {dictType: 'card_type'},{dictType: 'insurance_type'},]
  export default {
    components: {
      insuredModal
    },
    ...
    data() {
      ...
      return {
        ...
        searchForm: {},
        tableFormRules: {
          insuredNo:{required: true, message: '不能为空!', trigger: 'blur'},
          name:{required: true, message: '不能为空!', trigger: 'blur'},
          idType:{required: true, message: '不能为空!', trigger: 'blur'},
    ...
    methods: {
      ...
      /*  this.baseForm.region[1]=subFormSearch.caseInsuredData.city
        ...
        console.log(this.baseForm.region)
