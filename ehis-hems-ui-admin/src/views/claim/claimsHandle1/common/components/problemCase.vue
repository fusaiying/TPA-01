<template>
  <el-card class="box-card" style="margin-top: 10px;">
    ...
    <el-form ref="caseForm" :model="caseForm" label-width="120px" size="mini" :rules="caseFormRules">
      ...
      <el-row>
        <el-col :span="16">
          <el-form-item label="转出意见：" prop="conclusionView">
            <el-input type="textarea" style="width: 635px" :rows="4" maxlength="1000" v-model="caseForm.conclusionView"
                      clearable/>
          </el-form-item>
        </el-col>
      </el-row>
...
<script>
  import {editCaseInfoSuspend} from '@/api/claim/handleCom'
    ...
    data() {
      return {
        ...
        caseForm: {
          ...
          conclusionView: undefined,
        },
        caseFormRules: {
          problemType: {required: true, message: '问题件类型不能为空', trigger: 'change'},
          conclusionView: {required: true, message: '转出意见不能为空', trigger: 'change'},
        },
        dictList: [],
          ...
          if (valid) {
            this.$confirm(`是否发起问题件?`, '提示', {
              ...
              let data = {
                ...
                conclusionView: this.caseForm.conclusionView,
              }
