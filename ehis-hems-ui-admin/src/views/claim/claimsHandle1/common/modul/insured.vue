      ...
      <el-form ref="searchForm" :model="searchForm" label-width="170px" size="mini">
        ...
        <el-row>
          ...
          <span style="padding-right: 20px;">
             <el-button size="mini" type="primary" @click="restForm">重 置</el-button>
            <el-button
              size="mini"
              type="primary"
              @click="searchHandle"
            ...
            <el-button size="mini" type="primary" @click="confirmHandle">确 定</el-button>
          </span>
          </el-col>
        </el-row>
...
<!--                      <template slot-scope="scope">
        ...
        <el-table-column align="center" prop="idType" label="证件类型" width="200" show-overflow-tooltip/>
        <el-table-column :formatter="getCNStatus" align="center" prop="idNo" label="证件号码" show-overflow-tooltip/>
...
import {selectRecognizee,selectInsuredList} from '@/api/claim/handleCom'
    ...
    getPolicyInfoList(row, expandedRows) {
      ...
      this.policyLoading = true
        ...
        if (expandedRows.length > 0) {
          console.log('1111111')
          selectInsuredList(row.insuredNo).then(res => {
