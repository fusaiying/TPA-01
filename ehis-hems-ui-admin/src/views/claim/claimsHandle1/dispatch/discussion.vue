  ...
  <div class="app-container">
    <el-card class="box-card" style="margin-top: 10px;">
      ...
      <div style="position: relative">
        ...
        <el-button style="float: right;margin-top: -40px" size="mini" type="primary">退回受理</el-button>
        <el-divider/>
          ...
          <el-row>
            <el-col :span="12">
              <el-form-item label="客户备注：" prop="remark">
                <el-input  style="" col="2" type="textarea" row="4" maxlength="1000"
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="核赔依据：" prop="remark">
                <el-input style="width: 330px;" col="2" type="textarea" row="4" maxlength="1000"
        ...
        <el-form v-if="isActiveSpan2" ref="discussionForm" :model="discussionForm"  style="padding-bottom: 30px;margin-top:20px;margin-left: 5%" label-width="130px" :rules="rules"
                 label-position="right" size="mini">
          <el-row>
            <el-col :span="8">
          ...
          <el-row>
            <el-col :span="8">
              <el-form-item label="转出意见：" prop="remark">
                <el-input style="width: 330px;" col="2" type="textarea" row="4" maxlength="1000"
                          v-model="discussionForm.remark" class="item-width" clearable size="mini"
                          placeholder=""/>
              </el-form-item>
            </el-col>
          </el-row>
