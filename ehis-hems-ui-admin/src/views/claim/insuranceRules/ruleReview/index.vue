  ...
  <div class="app-container">
    ...
    <el-card class="box-card" style="margin-top: 10px;">
      <el-form ref="searchForm" :model="formSearch" style="padding-bottom: 30px;" label-width="110px"
               label-position="right" size="mini" @submit.native.prevent>
        <el-row>
          <el-col :span="8">
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane :label="`已处理(${completedTotal})`" name="02">
          <claimsTable v-loading="personListLading" :table-data="completedTableData" :status="activeName"/>
        </el-tab-pane>
      </el-tabs>
      <!--分页组件-->
      <pagination
...
<script>
  ...
  import {
    listAndPublicPool,
    pendingAndPersonPool,
    completedAndPersonPool,
    acquire
  ...
  export default {
    ...
    async mounted() {
      ...
      pendingAndPersonPool(params).then(res => {
      ...
      completedAndPersonPool(params).then(res => {
        if (res != null && res.code === 200) {
