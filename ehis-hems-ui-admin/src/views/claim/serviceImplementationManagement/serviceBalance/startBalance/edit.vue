  ...
  <div class="app-container">
    ...
    <div v-if="queryParams.settleType">
      ...
      >
        ...
        <el-table-column v-if="queryParams.settleType===settleTypeData.isCase || queryParams.settleType===settleTypeData.isCont || queryParams.settleType===settleTypeData.isPrice" key="settlementTime" prop="settlementTime" label="结算时间区间" width="150%" align="center" show-overflow-tooltip/>
        ...
        <el-table-column v-if="queryParams.settleType===settleTypeData.isCase" key="sex" prop="sex" label="性别" width="150%" align="center" :formatter="getSex" show-overflow-tooltip/>
