      ...
      <el-row>
        <el-col :span="16">
          <el-form-item label="联系人固定电话：" style="white-space: nowrap" prop="phone">
            国家区号+
            <el-input v-model="acceptForm.contactsPerson.homePhone" class="item-width" clearable style="width: 75px"/>
            区号
            <el-input v-model="acceptForm.contactsPerson.homePhone" class="item-width" clearable size="mini"
