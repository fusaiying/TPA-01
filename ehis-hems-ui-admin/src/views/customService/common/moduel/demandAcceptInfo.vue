<template>
  <el-card class="box-card" style="margin-top: 10px;">
    ...
    <el-form ref="ruleForm" :model="acceptForm" style="padding-bottom: 30px;" label-width="160px" :disabled="isDisabled || routerParams.status=='show'"
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="电话中心业务流水号：" prop="mobilePhone">
            <el-input v-model="acceptForm.callPerson.mobilePhone" class="item-width" clearable size="mini"
                      placeholder="请输入"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
        ...
        <el-col :span="8">
          <el-form-item label="受理渠道：" prop="serviceItem">
            <el-select v-model="acceptForm.serviceItem" class="item-width" placeholder="请选择" controls-position="right"
                       :min="0">
      ...
      <el-row>
        <el-col :span="8">
          <el-form-item label="联系人姓名：" prop="lxperson">
            <el-input v-model="acceptForm.contactsPerson.name" class="item-width" clearable size="mini"
                      placeholder="请输入"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
      ...
      <el-row>
        ...
        <el-col :span="8">
          <el-form-item label="联系人移动电话：" prop="mobilePhone">
            <el-input v-model="acceptForm.contactsPerson.mobilePhone" class="item-width" clearable size="mini"
                      placeholder="请输入"/>
          </el-form-item>
        </el-col>
        <el-col :span="8">
          <el-form-item label="E-MAIL：" prop="email">
            <el-input v-model="acceptForm.contactsPerson.email" class="item-width" clearable size="mini"
                      placeholder="请输入"/>
          </el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row>
        <el-col :span="16">
          <el-form-item label="联系人固定电话：" style="white-space: nowrap" prop="phone">
            国家区号+
            <el-input v-model="acceptForm.contactsPerson.linePhone1[0]" class="item-width" clearable style="width: 75px"/>
            区号
            <el-input v-model="acceptForm.contactsPerson.linePhone1[1]" class="item-width" clearable size="mini"
                      style="width: 75px" maxlength="50"/>
            号码
            <el-input v-model="acceptForm.contactsPerson.linePhone1[2]" class="item-width" clearable size="mini"
                      style="width: 120px" maxlength="50"/>
            分机号
            <el-input v-model="acceptForm.contactsPerson.linePhone1[3]" class="item-width" clearable size="mini"
                      style="width: 75px" maxlength="50"/>
          </el-form-item>
        </el-col>
      </el-row>
