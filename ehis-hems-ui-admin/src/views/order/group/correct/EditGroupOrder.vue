          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
              <el-form-item label="销售价格" prop="salePrice">
                <el-input placeholder="请输入销售价格" v-model="form.salePrice"/>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
              <el-form-item label="保底金额">
                <el-input placeholder="请输入保底金额" v-model="form.guaranteedAmount" clearable>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 返回 */
      back() {
        this.$router.push({path: '/order/group/correct'});
      },
      submit1() {
        // 表单为空校验
        this.$refs["form"].validate(valid => {
