    ...
    <el-row class="mb10">
      <el-card class="box-card" shadow="hover">
        <div slot="header" class="clearfix">
          <i class="el-icon-tickets mr5"></i><span>申请书列表</span>
        </div>

        <el-row :gutter="10" class="mb10">
          <el-button type="primary" icon="el-icon-check" :disabled="single" size="mini" @click="applicationCorrect">
            申请书订正
          </el-button>
  ...
  export default {
    ...
    methods: {
      ...
      applicationCorrect(row) {
        ...
        this.$router.push({path: '/order/group/correct/' + personalorderno});
      },
    }
  };
</script>
