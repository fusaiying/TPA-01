  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" :inline="true" label-width="125px">
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
              <el-form-item label="申请书编码">
                <el-input disabled clearable placeholder="申请书编码自动生成" v-model="form.personalorderno"/>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
      ...
      <el-row class="mt10 mb10">
        <el-card class="box-card" shadow="hover">
          <div slot="header" class="clearfix">
            <i class="el-icon-c-scale-to-original mr5"></i>
            <span>产品包选择</span>
          </div>
      ...
      <el-row class="mt10 mb10">
        <el-card class="box-card" shadow="hover">
          <div slot="header" class="clearfix">
            <i class="el-icon-takeaway-box mr5"></i>
            <span>产品包信息</span>
          </div>
          <!-- 第九行 -->
          <el-row>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 返回 */
      back() {
        this.$router.push({path: '/order/personal/correct'});
      },
    },
  }
</script>
