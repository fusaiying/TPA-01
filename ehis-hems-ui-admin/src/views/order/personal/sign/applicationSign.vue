  ...
  <div class="app-container">
    <el-form ref="form" :model="form" :rules="rules" :inline="true" label-width="125px">
          ...
          <el-row>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
              <el-form-item label="申请书编码">
                <el-input disabled placeholder="申请书编码自动生成" v-model="form.personalorderno" clearable/>
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
          ...
          <el-row>
            ...
            <el-col :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
              <el-form-item label="邮编" prop="buyPostCode">
                <el-input placeholder="请输入邮编" v-model="form.buyPostCode" maxlength="6" show-word-limit clearable/>
              </el-form-item>
            </el-col>
          </el-row>
      ...
      <el-row class="mt10 mb10">
        <el-card class="box-card" shadow="hover">
          <div slot="header" class="clearfix">
            <i class="el-icon-folder-add mr5"></i>
            <span>产品包选择</span>
          </div>
      ...
      <el-row class="mt10 mb10">
        <el-card class="box-card" shadow="hover">
          <div slot="header" class="clearfix">
            <i class="el-icon-copy-document mr5"></i>
            <span>合作伙伴/销售平台选择</span>
          </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      /** 返回 */
      back() {
        this.$router.push({path: '/order/personal/sign'});
      },
    },
  }
</script>
