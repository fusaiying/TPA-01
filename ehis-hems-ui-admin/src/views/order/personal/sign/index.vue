<template>
  <div class="app-container">
    ...
    <el-card class="box-card" shadow="hover">
      ...
      <el-row class="mb8">
        <el-button type="primary" icon="el-icon-s-promotion"  :disabled="single" size="mini" @click="applicationSign">申请书签发</el-button>
      ...
      <el-table v-loading="loading" :data="personalList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="应收金额" align="center" width="100"  show-overflow-tooltip/>
        <el-table-column label="服务费（单位：元）" align="center" width="150" prop="operator" show-overflow-tooltip/>
        <el-table-column label="财务到账金额" align="center" width="100" prop="operator" show-overflow-tooltip/>
        <el-table-column label="财务到账日期" align="center" prop="applicationdate" show-overflow-tooltip>
          <template slot-scope="scope">
            <span>{{ parseTime(scope.row.applicationdate, '{y}-{m}-{d}') }}</span>
          </template>
        </el-table-column>
        ...
        <el-table-column
          ...
          <template slot-scope="scope">
            <el-button
              ...
              type="text"
              icon="el-icon-check"
              @click="applicationSign(scope.row)"
  ...
  export default {
    ...
    methods: {
      ...
      applicationSign(row) {
        ...
        this.$router.push({path: '/order/personal/sign/' + personalorderno});
      },
    }
  };
</script>
