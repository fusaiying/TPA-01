    ...
    <el-form :model="form" ref="form" :rules="rules" :inline="true" v-show="showSearch" label-width="125px">
      <el-card class="box-card" style="margin-bottom: 10px">
        ...
        <el-form-item label="每月收入摊销标识" prop="amortizationflag">
          <el-select v-model="form.amortizationflag" placeholder="请输入每月收入摊销标识"
                     clearable
          >
            <el-option
        ...
        <el-form-item label="是否主动提供服务" prop="isprovideservice">
          <el-select v-model="form.isprovideservice" placeholder="请输入是否主动提供服务"
                     clearable
          >
            <el-option
              v-for="dict in sysYesNoOptions"
        ...
        <el-form-item label="是否提供在线服务" prop="isprovideonline">
          <el-select v-model="form.isprovideonline" placeholder="请输入是否提供在线服务"
                     clearable
          >
            <el-option
              v-for="dict in sysYesNoOptions"
        ...
        <el-form-item label="是否为标准产品" prop="isstandardproduct">
          <el-select v-model="form.isstandardproduct" placeholder="请输入是否为标准产品"
                     clearable
          >
            <el-option
              v-for="dict in sysYesNoOptions"
...
<!--        </el-table>-->
        <el-row style="text-align: right">
          <el-button type="cyan"
                     @click="handleQuery">服务产品条款
          </el-button>
          <el-button type="cyan"  @click="Return">返回
          </el-button>
          <el-button type="cyan"  @click="up">产品上线
          </el-button>
          <el-button type="cyan"  @click="down">下线
          </el-button>
        </el-row>
      </el-card>
...
<script>
  ...
  import {getServiceComNo, getServiceNetWorkList, getProvinceAll, getCityByProvince, getDistrictByCity} from "@/api/product/info";
...
//          ],
    ...
    methods: {
      ...
      Return() {
        this.$router.push({
          path: '/product/publishandmaintain/maintainindex/0'
        });
      },
      /** 搜索按钮操作 */
      handleQuery() {
